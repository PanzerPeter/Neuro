...
| **Traits & dispatch** | Required and default methods, associated types (`type Item` / `Self::Item`), operator traits, `impl Trait` (static) and `dyn Trait` (vtable) dispatch with object-safety checks |
