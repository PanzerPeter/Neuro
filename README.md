...
| 2E | Value model: borrowee tracking for reads, moves and reassignment, by-value passing for non-`Copy` types, drop coverage for struct fields and reassigned bindings, assignment through an index or a field | In progress |
