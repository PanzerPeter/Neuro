...
declarations in v2.7.0, and the `Trait<Assoc = T>` bound form in v2.8.0; the `Iterator`
protocol is next. Start at the top of 2A in the roadmap, and move to `2B — Tensor Core`
