...
impl<'ctx> CodegenContext<'ctx> {
    ...
    pub(super) fn codegen_char_slice(
        ...
        let start_found = self.builder.build_int_compare(
            IntPredicate::SGT,
            start_byte,
            not_found,
            "cslice.start.ok",
    ...
    fn build_char_offset_body(&self, function: FunctionValue<'ctx>) -> CodegenResult<()> {
        ...
        let byte_slot = self.builder.build_alloca(i64_type, "cp.byte")?;
        let seen_slot = self.builder.build_alloca(i64_type, "cp.seen")?;
        self.builder.build_store(byte_slot, i64_type.const_zero())?;
        self.builder.build_store(seen_slot, i64_type.const_zero())?;
        ...
        self.builder.build_store(byte_slot, after_lead)?;
        ...
        let kept = self
            ...
            .into_int_value();
        self.builder.build_store(byte_slot, kept)?;
        self.builder
