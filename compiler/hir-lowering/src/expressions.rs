...
impl Lowerer {
    ...
    fn pattern_enum_name(&self, base: &str, scrut_ty: &HirType) -> String {
        match scrut_ty {
            HirType::Enum(name)
    ...
    fn enum_construction_target(&self, base: &str, expected: Option<&HirType>) -> String {
    ...
    fn enum_return_type_args(&self, base: &str) -> Option<Vec<crate::MonoArg>> {
    ...
    fn lower_generic_enum_struct_literal(
        &mut self,
        base: &str,
        variant: &str,
        fields: &[FieldInit],
