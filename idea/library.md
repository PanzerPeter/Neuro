...
├── name-resolution/                   # ☐ Symbol resolution and scope analysis
...
├── shared-types/                      # Common type definitions across slices
...
├── source-location/                   # Source mapping and position tracking
...
├── diagnostics/                       # Diagnostic message infrastructure
...
```
compiler/neurc/                       # Main compiler driver
